...
<head>
    ...
    <title>CureBooking - Search with Details</title>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🏥 CureBooking</h1>
            <p>Find doctors and clinics with detailed information</p>
        </div>

        <div class="search-section">
            <div class="search-box">
                <input type="text" class="search-input" placeholder="Search doctors, clinics, specialties..." id="searchInput">
                <div class="search-results" id="searchResults"></div>
            </div>
        </div>

        <div class="details-section" id="detailsSection">
            <button class="back-btn" onclick="hideDetails()">← Back to Search</button>
