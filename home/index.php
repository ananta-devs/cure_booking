<?php
    ...
    $stmt = $pdo->prepare("SELECT doc_id, doc_name, doc_specia, doc_img, fees FROM doctor LIMIT 4");
    $stmt->execute();
    ...
    <section class="hero">
        <div class="container hero-inner">
            ...
            <div class="model" data-aos="fade-left">
                <img src="http://localhost/cure_booking/home/assets/appointment_img2.png" />
            </div>
        </div>
    </section>
    ...
    <section class="app-section">
        <div class="container app-container">
            <div class="app-content" data-aos="fade-right">
                ...
                <div class="app-buttons">
                    ...
                    <a href="https://www.apple.com/app-store/" target="blank" class="app-btn appstore">
                        <img class="store" src="http://localhost/cure_booking/home/assets/app-store.png" alt="App Store Logo" />
                        <div class="btn-text">
                            <span class="app-btn-text-small">Get it on</span>
            ...
            <div class="app-image" data-aos="fade-left">
                <img src="http://localhost/cure_booking/home/assets/phone-desktop.png" alt="Mobile App">
            </div>
        </div>
    </section>
