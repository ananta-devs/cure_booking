    ...
    row.innerHTML = `
        ...
        <td>
            <div class="action-buttons">
                <button class="action-btn view-btn" onclick="viewBookingDetails('${bookingId}')" title="View Details">
                    <i class="fa fa-eye"></i>
                </button>
                <button class="action-btn status-btn" onclick="showStatusModal('${bookingId}', '${status}')" title="Update Status">
                    <i class="fa fa-edit"></i>
                </button>
                <button class="action-btn upload-btn" onclick="showUploadModal('${bookingId}')" title="Upload Report">
...
async function viewBookingDetails(bookingId) {
    try {
        ...
        showError("Network error while loading booking details: " + error.message);
    }
}
            ...
            <div class="detail-section">
                ...
                <div class="detail-grid">
                    ...
                    <div class="detail-item">
                        ...
                        <span>${booking.formatted_collection_date || 'N/A'}</span>
                    </div>
                    <div class="detail-item">
                ...
                <div class="detail-section">
                    ...
                    <div class="report-info">
                        ...
                        <div class="report-item">
                            ...
                            <span>${booking.formatted_report_date || 'N/A'}</span>
                        </div>
...
async function deleteBooking(bookingId) {
    ...
    try {
        ...
        if (data.success) {
            ...
            showError("Failed to delete booking: " + (data.message || 'Unknown error'));
        }
    } catch (error) {
...
function debugUploadForm() {
    ...
    console.log('Booking ID input:', document.getElementById("uploadBookingId"));
    ...
    console.log('Upload button:', document.querySelector('#uploadReportForm button[type="submit"]'));
}
...
function filterBookings() {
    ...
    if (dateFilter && dateFilter.value) {
        ...
        filtered = filtered.filter(booking => booking.sample_collection_date === selectedDate);
    }
