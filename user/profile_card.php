...
<body>
    ...
    <script>
        ...
        function updateProfileDisplay() {
            ...
            document.getElementById('join-date').textContent = `Joined in ${formattedDate}`;
            
            // Update mobile
            const mobileElement = document.getElementById('mobile-value');
            mobileElement.textContent = profileData.mobile || 'Not provided';
            if (!profileData.mobile) {
                mobileElement.classList.add('placeholder');
            }
        ...
        function showError(message) {
            ...
            profileCard.insertBefore(errorDiv, profileCard.firstChild);
            ...
            if (field === 'name') {
                ...
                form.innerHTML = `
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="value" class="form-input" value="${profileData.name}" placeholder="Enter your name" required>
                        <div style="font-size: 12px; color: #6b7280; margin-top: 4px;">
                            Will be displayed as: "Hi [your name]!"
                        </div>
                    </div>
                `;
            } else if (field === 'mobile') {
                title.textContent = 'Edit Mobile Number';
                form.innerHTML = `
                    <input type="hidden" name="action" value="update_profile">
                    <input type="hidden" name="field" value="mobile">
                    <div class="form-group">
                        <label class="form-label">Mobile Number</label>
                        <input type="tel" name="value" class="form-input" value="${profileData.mobile || ''}" placeholder="Enter mobile number">
                    </div>
                `;
            } else if (field === 'email') {
                title.textContent = 'Edit Primary Email';
                form.innerHTML = `
                    <input type="hidden" name="action" value="update_profile">
                    <input type="hidden" name="field" value="email">
                    <div class="form-group">
                        <label class="form-label">Email Address</label>
                        <input type="email" name="value" class="form-input" value="${profileData.email}" placeholder="Enter email address" required>
                    </div>
                `;
                ...
                form.innerHTML = `
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="new_password" id="new-password" class="form-input" placeholder="Enter new password" required minlength="6">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Confirm New Password</label>
                        <input type="password" name="confirm_password" id="confirm-password" class="form-input" placeholder="Confirm new password" required minlength="6">
                    </div>
                `;
            }
