...
<nav class="sidebar" id="sidebar">
    ...
    <ul class="nav-menu">
        <li>
            <a
                href="http://localhost/cure_booking/providers/clinic/home.php"
        ...
        <li>
            <a
                href="http://localhost/cure_booking/providers/clinic/manage-doctors.php"
        ...
        <li>
            <a
                href="http://localhost/cure_booking/providers/clinic/lab-bookings.php"
        ...
        <li>
            <a
                href="http://localhost/cure_booking/providers/clinic/settings.php"
    ...
    <div class="sign-out">
        <a href="http://localhost/cure_booking/providers/logout.php" class="nav-link" id="signOutBtn"
