...
function handleDoctorLogin($pdo, $email, $inputPassword) {
    ...
    if ($passwordMatch) {
        ...
        sendResponse(true, "Welcome back, Dr. " . $doctor['doc_name'] . "!", "http://localhost/cure_booking/providers/doctor/doctor_show.php", [
...
function handleClinicLogin($pdo, $email, $inputPassword) {
    ...
    if ($passwordMatch) {
        ...
        sendResponse(true, "Welcome back, " . $clinic['clinic_name'] . "!", "http://localhost/cure_booking/providers/clinic/home.php", [
